...
export function SportsMetadataFixture() {
  ...
  return <main style={{height: "100dvh", padding: "16px", background: "#050607"}}><SportsGuidePane channels={channels} guide={guide} onPlay={() => {}} onEnter={() => {}} onOpenCategories={() => {}} /></main>;
}
